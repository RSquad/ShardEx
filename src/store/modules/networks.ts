...
export const defaultNetworks = [
  { name: "Everscale testnet network", server: "http://net.ton.dev", explorer: "https://net.ton.live", isDev: true },
  { name: "Everscale mainnet network", server: "http://main.ton.dev", explorer: "https://ton.live", isDev: false },
  { name: "Everscale local network", server: "http://0.0.0.0", explorer: "", isDev: true },
];
