...
export default {
  ...
  async handle(task: any) {
    ...
    const reactiveInteractiveTask = await store.dispatch("tasks/getTask", interactiveTaskId);
    const interactiveTask = reactiveInteractiveTask;
    console.log(interactiveTask);
